...
$cokOnemliKontroller = [
    ["Merkezi Kilit Sistemi Uzaktan Kumandası", "✓", "Çalışıyor"],
];
$ortaOnemliKontroller = [
    ["Jantlar", "⚠️ Deforme", ""],
    ["Sol Ön Lastik Yılı", "✓", "İyi"],
    ["Sol Ön Lastik Diş Derinliği (mm)", "✓", "İyi"],
    ["Sol Arka Lastik Yılı", "✓", "İyi"],
    ["Sol Arka Lastik Diş Derinliği", "✓", "İyi"],
    ["Sağ Arka Lastik Yılı", "✓", "İyi"],
    ["Sağ Arka Lastik Derinliği", "✓", "İyi"],
    ["Sağ Ön Lastik Yılı", "✓", "İyi"],
    ["Sağ Ön Lastik Derinliği", "✓", "İyi"],
    ["Ön Sol Far", "✓", "Çalışıyor"],
    ["Ön Sağ Far", "✓", "Çalışıyor"],
];
$azOnemliKontroller = [
    ["Bagaj İçi Genel Durum", "Orta", ""],
    ["Araçta Ezik-Çizik-Göçük Mevcut mu?", "⚠️ Evet", ""],
    ["Sol Ayna", "✓", "Çalışıyor"],
    ["Arka Sol Stop", "✓", "Çalışıyor"],
    ["Sol Kapı Kolları", "✓", "Çalışıyor"],
    ["Ön Sol Sinyal", "✓", "Çalışıyor"],
];
$kontroller = [];
...
<head>
    <meta charset="utf-8">
    <title>Oto Ekspertiz Raporu - Sayfa 27 - <?= e($sasiNo) ?></title>
...
<body>
    <div class="page">
        ...
        <div class="title">GENEL KONDİSYON / DIŞ EKSPERTİZ VE CHECK-UP RAPORU</div>
