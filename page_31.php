...
$azOnemliKontroller = [
    ["Sağ Ön - Yan Airbag Döşemesi", "✓", "Yok"],
    ["Sağ Ön - Koltuk Isıtma", "✓", "Yok"],
    ["Sağ Ön - Elektrikli Koltuk", "✓", "Yok"],
    ["Sağ Ön - Emniyet Kemeri ", "✓", "Çalışıyor"],
    ["Sağ Ön - Kapı Kilit Kollar ve Döşeme", "✓", "Çalışıyor"],
    ["Araca Acil Olarak Detaylı Temizlik Gerekli mi? ", "✓", "Hayır"],
    ["Araçta Olağan Dışı Bir Ses Mevcut mu?", "✓", "Sorunsuz"],
    ["Pandizot", "✓", "Sorunsuz"],
    ["Sunroof Perdesi", "✓", "İyi"],
    ["Taban Halısı", "✓", "Yok"],
];
...
<head>
    <meta charset="utf-8">
    <title>Oto Ekspertiz Raporu - Sayfa 31 - <?= e($sasiNo) ?></title>
