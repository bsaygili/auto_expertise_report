...
$obdNoktalar = [
  'Motor Güç Ölçümü (kW,hp)' => 'İyi',
  'Motor Tork Ölçümü (Nm, kgm)' => 'İyi',
  'Vites Geçişleri Kontrolü' => 'Vites Geçişleri Sorunsuz',
  'İvmelenme Kontrolü' => 'Sorunsuz',
  'Araca Ait Anlık Dinamometre Ölçüm Çıktısı' => 'Yol Testi Yapıldı',
];
function e($v)
{
...
<head>
  <meta charset="UTF-8">
  <title>Oto Ekspertiz Raporu - Sayfa 26 - <?= e($sasiNo) ?></title>
...
<body>
  <div class="page">
    ...
    <div>
      ...
      <div class="title">DYNO/ YOL TESTİ</div>
      <div class="stars-section-container">
        ...
        <div class="obd-car-section">
          <img src="images/dyno-yol.png" alt="Araç Görseli" class="car-bg">
        </div>
      </div>
