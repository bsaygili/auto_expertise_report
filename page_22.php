...
$azOnemliKontroller = [];
$kontroller = [
  ["Sağ Ön Çamurluk", "✓ Orijinal", ": 90-110 µ (mikron)"],
  ["Ön - Cam", "✓ Orijinal", ""],
  ["Sunroof", "✓ Sorunsuz", ": Cam Tavan"],
  ["Arka Cam", "✓ Orijinal", ""],
  ["Araca Kirli Halde mi Ekspertiz Yapıldı?", "✓ Araç Temizdi", ""],
  ["Araç ''FİİLEN AĞIR İŞLEMLİ'' Kategorisinde mi? (Bu yorum usta görüşüdür.)", "✓ Araçta Ağır İşlem Görülmemiştir", ""],
  ["Araç Alt Tabanı Kontrolü", "✓ Orijinal", ""],
  ["Karalama Kağıdı", "✓ Karalama Kağıdı Fotoğrafı Eki", ""],
  ["Sağ Frangart (Sağ Üst Direk)", "✓ Orijinal", ""],
  ["Sol Frangart (Sol Üst Direk)", "✓ Orijinal", ""],
  ["Gösterge Panelinde Airbag Işığı Yanıyor mu?", "✓ Hayır", ""],
  ["Araç Alt Ön Kısım Fotoğrafı", "Araç Alt Ön Kısım Fotoğrafı", ""],
  ["Araç Alt Orta Kısım Fotoğrafı", "Araç Alt Orta Kısım Fotoğrafı", ""],
  ["Araç Alt Arka Kısım Fotoğrafı", "Araç Alt Arka Kısım Fotoğrafı", ""],
  ["Airbag (Hava Yastıkları) Usta Kanaati", "✓ Otorapor Airbag Kontrol Paketi Uygulanmadıysa Yetkili Serviste İncelenmesi Gereklidir.", ""],
  ["Araç Genelinde Dolu Hasarı Mevcut Mu ?", "✓ Hayır", ""],
  ["Sağ Ön Kapı İçi", "✓ Orijinal", ""],
  ["Sağ Ön Şasi Ucu", "✓ Orijinal", ""],
];
...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 22 - <?= e($sasiNo) ?></title>
