...
$cokOnemliKontroller = [
  ["Arazi Şaftı Genel Durumu", "✓", "İyi"],
  ["Motor Karteri Yağ Sızdırmazlığı", "✓", "İyi"],
  ["Ön Krank Keçesi Yağ Sızdırmazlığı", "✓", "İyi"],
  ["Şanzıman ve Diferansiyel Yağ Sızdırmazlığı", "✓", "İyi"],
  ["Yağ Sızdırmazlık Ön Diferansiyel", "✓", "İyi"],
  ["Yağ Soğutucusu Yağ Sızdırmazlığı", "✓", "Hayır"],
  ["Debriyaj Balatası ve Kavrama Sistemi Durumu", "✓", "Hayır"],
  ["Arka Diferansiyel Boşluk ve Yağ Sızdırmazlık", "✓", "Hayır"],
  ["Arazi Şanzımanı Yağ Sızdırmazlığı", "✓", "Hayır"],
  ["Arka Krank Keçesi Yağ Sızdırmazlığı", "✓", "Yok"],
];
$ortaOnemliKontroller = [
  ["Araç Alt Kısmı Hasar Kontrolü", "✓", "İyi"],
  ["Sağ-Sol Ön Fren Kaliperi Hidrolik Sızdırmazlığı", "✓", "İyi"],
  ["Ön Fren Balata ve Diskler", "✓", "İyi"],
  ["Sol Ön Amortisör", "✓", "İyi"],
  ["Sağ Ön Amortisör", "✓", "İyi"],
  ["Turbo Alt Kontrolü", "✓", "İyi"],
  ["Motor ve Şanzıman Alt Takozları", "✓", "İyi"],
  ["Diferansiyel Tranmisyon Mili ve Takoz", "✓", "İyi"]
];
$azOnemliKontroller = [];
$kontroller = [];
...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 11 - <?= e($sasiNo) ?></title>
...
<body>
  <div class="page">
    ...
    <div class="title">ALT / ÖN / MEKANİK EKSPERTİZ ve CHECK-UP RAPORU</div>
