...
$cokOnemliKontroller = [
    ["Airbag Işığı Yanıyor mu?", "✓", "Yanmıyor"],
    ["Direksiyon Simidi Airbag Kontrolü", "✓", "Sorunsuz"],
    ["Torpido Airbag Kontrolü", "✓", "Sorunsuz"],
    ["Perde Airbag Kontrolü", "✓", "Sorunsuz"],
    ["Emniyet Kemerleri Direnç Kontrolü ", "✓", "Sorunsuz"],
    ["Araç Satıcısı/Vekili İzin Formu Fotoğrafı ", "✓", "Araç Satıcısı/Vekili İzin Formu Fotoğrafı"],
];
$ortaOnemliKontroller = [
    ["Diz Airbag Kontrolü", "✓", "Yok"],
];
$azOnemliKontroller = [
    ["Koltuk Airbag Kontrolü", "✓", "Sorunsuz"],
];
$kontroller = [];
...
<head>
    <meta charset="utf-8">
    <title>Oto Ekspertiz Raporu - Sayfa 32 - <?= e($sasiNo) ?></title>
...
<body>
    <div class="page">
        ...
        <div class="title">Airbag (Hava Yastıkları) Kontrol Testi RAPORU</div>
