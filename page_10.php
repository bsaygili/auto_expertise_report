...
$ortaOnemliKontroller = [
  ["Akü(%)", "✓", "İyi"],
  ["Direksiyon Pompası ve Boruları Yağ Kaçağı Durumu", "✓", "İyi"],
  ["Motor Yağ Seviyesi", "✓", "İyi"],
  ["Yakıt Sistemi ve Sızdırmazlık", "✓", "İyi"],
  ["Radyatör Genel Durumu", "✓", "İyi"],
  ["Intercooler Genel Durumu", "✓", "İyi"],
  ["Soğutma Fanları", "✓", "İyi"],
  ["Soğutma Suyu Hortumları ve Sızdırmazlık", "✓", "İyi"],
  ["Klima Boruları", "✓", "İyi"],
  ["Turbo Boruları Genel Durumu", "✓", "İyi"],
  ["Emme Manifoldu Durumu", "✓", "İyi"]
];
$azOnemliKontroller = [
  ["Conta Kaçak Testi Yapıldı mı?", "⚠️ conta kaçak testi satın alınmıştır ve yapılmıştır.", ""],
  ["Motor Koruyucu Kapağı / Hava Filtresi ve Boruları", "✓", "İyi"],
  ["Antifriz", "✓", "İyi"],
  ["Fren Hidroliği Durumu", "✓", "İyi"],
  ["Motor Üst Bölge Yağ Sızdırmazlığı", "✓", "İyi"],
  ["Sol Kule Bilyaları", "✓", "İyi"],
  ["Sağ Kule Bilyaları", "✓", "İyi"]
];
$kontroller = [];
...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 10 - <?= e($sasiNo) ?></title>
