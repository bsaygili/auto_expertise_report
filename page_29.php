...
$cokOnemliKontroller = [
    ["Genel Torpido Kaplama", "✓", "İyi"],
];
$ortaOnemliKontroller = [
    ["Klima ve Izgaralar", "✓", "İyi"],
    ["Silecek Far ve Diğer Kollar", "✓", "İyi"],
    ["Sağ Ön - Cam Düğmeleri", "✓", "Çalışıyor"],
];
$azOnemliKontroller = [
    ["Direksiyon Simidi", "⚠️ Deforme", ""],
    ["Araç Kozmetiğinde Kullanıma Bağlı Deformasyon Mevcut mu?", "Leke Mevcut", ""],
    ["Arıza Işık veya Uyarısı Mevcut mu?", "✓", "Hayır"],
    ["Radyo ve Ses Sistemi", "✓", "Çalışıyor"],
    ["Vites Kolu Boşluk ve Yıpranma", "✓", "İyi"],
    ["Arka Cam Rezistans Genel Durumu", "✓", "İyi"],
    ["Bardaklık", "✓", "İyi"],
    ["Çakmak", "✓", "Çalışıyor"],
    ["El Fren Kolu veya Düğmesi", "✓", "İyi"],
    ["Tavan Aydınlatması", "✓", "Çalışıyor"],
    ["Tavan Döşemesi", "✓", "Çalışıyor"],
    ["Sunroof Düğmesi", "✓", "Çalışıyor"],
    ["Korna", "✓", "Çalışıyor"],
    ["Direksiyon Simidi Tuşları", "✓", "Çalışıyor"],
];
$kontroller = [];
...
<head>
    <meta charset="utf-8">
    <title>Oto Ekspertiz Raporu - Sayfa 29 - <?= e($sasiNo) ?></title>
