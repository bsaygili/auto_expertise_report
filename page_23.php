...
$azOnemliKontroller = [];
$kontroller = [
  ["Sol Ön Kapı İçi", "✓ Orijinal", ""],
  ["Sol Ön Şasi Ucu", "✓ Orijinal", ""],
  ["Araç Genelinde Dolu Onarımı Mevcut mu?", "✓ Hayır", ""],
  ["Araç Genelinde Kuş Pisliği ve Boya Bozulmaları Mevcut mu?", "✓ Hayır", ""],
];
...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 23 - <?= e($sasiNo) ?></title>
