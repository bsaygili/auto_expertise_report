...
$ortaOnemliKontroller = [
  ["Torsiyon Burç-Denge Kolları ve Salıncak Burç- Fişekleri", "✓", "İyi"],
  ["Yakıt Deposu ve Yakıt Hortumları", "✓", "İyi"],
  ["Arka Fren Balataları ve Diskler", "✓", "İyi"],
  ["Sol Arka Amortisör ve Helezon Yayları", "✓", "İyi"],
  ["Sağ Arka Amortisör ve Helezon Yayları", "✓", "İyi"],
  ["Sağ Arka Amortisör ve Helezon Yayları", "✓", "İyi"],
  ["Airmatik", "✓", "İyi"],
  ["Direksiyon Kutusu Yağ Sızdırmazlığı", "✓", "İyi"],
  ["Lastiklerin Genel Durumu", "✓", "İyi"],
  ["Ön Fren Hortumları", "✓", "İyi"],
  ["Arka Fren Hortumları", "✓", "İyi"]
];
$azOnemliKontroller = [
  ["Motor Muhafaza ", "✓", "İyi"],
  ["Ön Aks ve Aks Körükleri", "✓", "İyi"],
  ["Sol Ön Rotil, Rot Kolu ve Rot Başı", "✓", "İyi"],
  ["Sağ Ön Rotil, Rot Kolu ve Rot Başı", "✓", "İyi"],
  ["Sol Ön Salıncak Fişeği", "✓", "İyi"],
  ["Sağ Ön Salıncak Fişeği", "✓", "İyi"],
  ["Taban Plastik Bakalitleri", "✓", "İyi"],
];
$kontroller = [];
...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 12 - <?= e($sasiNo) ?></title>
