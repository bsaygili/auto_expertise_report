...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 2 - <?= e($chassis) ?></title>
...
<body>
  <div class="page">
    ...
    <!-- BAŞLIK / SUB -->
    <div style="text-align:center; margin-bottom:6px; font-size:11px; color:#444;"><?= e($bayiName) ?></div>
