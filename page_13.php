...
$azOnemliKontroller = [
  ["Egzoz Borusu ve Susturucu Genel Durumu ", "✓", "İyi"],
  ["El Freni Halatları", "✓", "İyi"],
  ["Arka Aks ve Aks Körükleri", "✓", "İyi"],
  ["Araca Rot-Balans Ayarı ya da Kontrolü Gerekli Mi?", "✓", "İyi"]
];
$kontroller = [];
function e($v)
{
...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 13 - <?= e($sasiNo) ?></title>
