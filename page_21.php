...
$kontroller = [
  ...
  ["Sol Ön - Şasi", "✓", "Orjinal"],
  ["Sağ Ön - Şasi", "✓", "Orjinal"],
  ["Sol Ön - Podye Sacı", "✓", "Orjinal"],
  ["Sağ Ön - Podye Sacı", "✓", "Orjinal"],
  ["Sol Ön - Kule", "✓", "Orjinal"],
  ["Sağ Ön - Kule", "✓", "Orjinal"],
  ["Ön Panel", "✓", "Orjinal"],
  ["Arka Sol Şasi", "✓", "Orjinal"],
  ["Arka Sağ Şasi", "✓", "Orjinal"],
  ["Arka - İç Panel", "✓", "Orjinal"],
  ["Arka Havuz İçi", "✓", "Orjinal"],
  ["Sol Ön - İç Direk", "✓", "Orjinal"],
  ["Sol Orta İç Direk", "✓", "Orjinal"],
  ["Sol Arka Kapı İçi", "✓", "Orjinal"],
  ["Sağ Ön İç Direk", "✓", "Orjinal"],
  ["Sağ Arka Kapı İçi", "✓", "Orjinal"],
  ["Sağ Orta İç Direk", "✓", "Orjinal"],
];
...
<head>
  <meta charset="utf-8">
  <title>Oto Ekspertiz Raporu - Sayfa 21 - <?= e($sasiNo) ?></title>
